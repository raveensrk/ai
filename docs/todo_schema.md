...
Canonical format for todo items in notes files ([inbox.md](../notes/inbox.md), task lists) across every project. It formalizes the format already in use in the inbox; referenced from [AGENTS.md](../AGENTS.md).
